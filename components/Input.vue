  ...
  <span>
    ...
    <span v-if="edit">
      ...
      <span title="Confirm" @click="handleSubmit">
        <svg
          id="Check"
          class="ml-1 w-5 inline cursor-pointer"
          version="1.1"
        ...
        <span title="Cancel" @click="handleCancel">
          <svg
            id="Minus"
            class="ml-1 w-5 inline cursor-pointer"
            version="1.1"
          ...
          >
            <path
              fill="#d14b4b"
              d="M16,10c0,0.553-0.048,1-0.601,1H4.601C4.049,11,4,10.553,4,10c0-0.553,0.049-1,0.601-1H15.4
